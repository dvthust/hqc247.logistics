...
const serviceData = [
  {
    ...
    info: 'Hqc247 Logistics chuyên vận chuyển các loại hàng Container 20, container 40, hàng quá khổ, hàng siêu trường, siêu trọng, các loại hàng rời, các loại hàng thiết bị, kết cấu thép, tôn tấm, thiếc, kẽm, chì, các loại hàng bao, kiện…'
  },
  {
    id: 2,
    title: 'Vận chuyển đường biển',
    icon: 'sprite os-truck',
    info: 'Với Hqc247 Logistics, khách hàng có được sự lựa chọn linh hoạt và rộng rãi các dịch vụ vận chuyển đường biển. Chúng tôi cung ứng dịch vụ vận tải hàng nguyên công ten nơ, hàng gom, hàng rời và dịch vụ môi giới tàu.'
  },
  {
    id: 4,
    title: 'VẬN CHUYỂN ĐƯỜNG SẮT',
    icon: 'sprite os-exchange-rate',
    info: 'Hqc247 Logistics cung ứng dịch vụ vận chuyển đường sắt hàng gom theo lịch trình nhất định, vận chuyển nguyên toa xe, hàng không nguyên toa, đặc biệt là vận chuyển hàng quốc tế nhập xuất tuyến Trung Quốc và các nước trong khối OECD.'
  },
  {
    id: 3,
    title: 'Ghép nhóm đánh hàng',
    icon: 'sprite os-truck-together',
    info: 'Hqc247 Logistics cam kết và đảm bảo hàng hóa của quý khách sẽ về Việt Nam trong thời gian nhanh nhất.'
  },
]
