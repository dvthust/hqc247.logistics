...
const testimonialData = [
  {
    ...
    info: 'Tôi đã từng sang tận Quảng Châu đánh hàng, nhưng khi gặp dịch vụ của Hqc247 thì thấy việc sang tận nơi không còn cần thiết nữa. Các bạn đã giúp tôi tiết kiệm được thời gian, công sức, chi phí đi lại.'
  },
  {
    id: 2,
    ...
    info: 'Hqc247 đã cho chúng tôi một lợi thế cạnh tranh mới trong ngành bán lẻ thời trang, bán hàng ngày nay không chỉ ở cửa hàng mà còn là cạnh tranh về nguồn hàng và chi phí nhập hàng.'
  },
  {
    id: 3,
...
export default function TestimonialInfo() {
  ...
  return <chakra.div bg={'#f9f9fb'}>
    <chakra.div py={6} maxW="1200px" mx="auto">
      <GeneralTitle
          title={'KHÁCH HÀNG NÓI VỀ HQC247'}
